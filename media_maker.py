#Creates compressed videos from images with grand thrught on first frame and makes new folders to placed there videos and other files form the same folder
#Aswell makes new javascript list of video names
...
def make_new_list(source_folder, output_list_folder):
...
def make_mask(source_folder):
    ...
    for child in list_vot_child:
        color_path = source_folder + "/" + child + "/color"
        rect_path = source_folder + "/" + child + "/init_rect.txt"
        ...
        combined_output_path = color_path + "/00000000mask.jpg"
...
if __name__ == '__main__':
    ...
    output_folder = "version_09/media"  # where do you want the result videos with compression
    ...
    output_list_folder = "/version_09/js" #replaced it with a path to your ja section

    make_new_list(source_folder, output_list_folder)
